...
git clone
```
* Команда, используемая для загрузки и просмотра последних коммитов, сделанных другими людьми из ветвей удаленного отслеживания, но без объединения этих коммитов в ваш локальный репозиторий
```
git fetch 
```
