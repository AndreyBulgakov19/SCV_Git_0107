...
## 15. Добавление удаленного репозитория

Добавление репозитория осуществляется командой:

> git clone <address_repository>

****ВАЖНО!**** *После клонирования репозитория необходимо
перейти в его локальную директорию, чтобы иметь возможность
с ним работать. Делается это командой:*

> cd <dir_name>

## 16. Запись изменений в удаленный репозиторий

Запись изменений в удаленный репозиторий осуществляется
командой:

> git push

## 17. Обновление данных из удаленного репозитория

"Стягивание" актуальных изменений из удаленного репозитория
осуществляется командой:

> git pull

18. Работа с репозиториями на Github

    1. Создание репозитория:
       * Необходимо зарегистрироваться на 
[Github](https://github.com/)
       * Создать свой репозиторий, нажав на кнопку:
![AddRepositoryGithub](AddRepositoryGithub.png)
       * Далее продолжить с настройками по умолчанию.

    2. Внесение собственного вклада в проекты:
       * Для того, чтобы создать ответвление проекта,
зайдите на страницу проекта и нажмите кнопку 
«Создать ответвление» («Fork»), которая расположена в
правом верхнем углу:

         ![ForkRepositoryGithub](ForkRepositoryGithub.png)
       * Клонируйте репозиторий локально при необходимости.
            > git clone <address_repository>
       ...
       * Откройте запрос на слияние на GitHub.
            ![NewPullRequest](NewPullRequest.png)
       * Внесите комментарий для владельца репозитория, из которого будет понятна
...
## 19. Связь локального и удаленноого репозиториев

Связать локальный репозиторий можно при помощи команды:

> git remote add rep_name <url_rep>

Посмотреть список связанных репозиториев можно командой:

> git remote show

Отправить изменения в связанный репозиторий можно командой:

> git push <rep_name> <branch_name>