...
Для удаления веток можно воспользоваться одной из 
двух команд:

> git branch -d <branch_name>

___*Данная команда выдаст предупреждение в случае, если 
есть несохраненные изменения в удаляемой ветке___

> git branch -D <branch_name>

___*Данная команда принудительно удалит ветку, даже если
есть несохраненные изменения в удаляемой ветке___