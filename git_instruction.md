...
## 4. Созданее новой ветки
Следущим шагом будет создание новой ветки - это необходимо сделать тк на данном этапе репозиторий находится на авторской ветке. Создаём ветку и сразу переходим на неё командой
```
...
```
 ...
 git push
 ```
Если всё сделано правильно ваша версия появится но для просмотра проделаной работы и всех коммитов необходимо на gh выбрать ветку в которой проделывались все изменения
...
![fotoPullRequest](Pull_request.png)
Далее нажимаем __New pullrequest__ и оказываемся на странице где необходимо выбрать ветку в которой производилась вся работа, после чего нажимаем __Create pull request__

![fotoCreate](CreatePullRequest.png)
